...
struct GroupSchedule: View {
    ...
    @State private var backFromGroupSchedule : Bool = false
                    ...
                    ScrollView {
                        VStack (spacing:0){
                            ...
                            .navigationBarItems(leading: CustomBackButton(){
                                clearStatesWithAction(valueState: &backFromGroupSchedule)
                            })
                            ...
                            .fullScreenCover(isPresented: $backFromGroupSchedule) {
                                StudentMainTabView()
                            }
