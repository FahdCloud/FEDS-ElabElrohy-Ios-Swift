//
//  GroupEvaluationsWebView.swift
//  FEDS-Dev-Ver-Two
//
//  Created by Omar Pakr on 31/12/2024.
//
...
@available(iOS 16.0, *)
struct GroupEvaluationsWebView: View {
    ...
    var body: some View {
        let mediaUrl : String = genralVm.constants.BASE_URL + "/external-platform/educational-student-group-evaluations;" + "userStudentToken=" + userToken + ";userLoginSessionToken=" + userLoginSessionToken + ";educationalGroupToken=" + groupToken
