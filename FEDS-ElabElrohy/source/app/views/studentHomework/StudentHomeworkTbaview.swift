...
struct StudentHomeworkTbaview: View {
    ...
    content: {
        ...
        CustomMenuAxisTab(tagAxisTab: 0
                          ...
                          , imageName: "file-2") {
            StudentHomeworkView(finishedExam: Constants().EXAM_SEARCH_STATUS_TYPE_CURRENT)
        }
        ...
        CustomMenuAxisTab(tagAxisTab: 1
                          ...
                          , imageName: "complete") {
            StudentHomeworkView(finishedExam: Constants().EXAM_SEARCH_STATUS_TYPE_FINISHED)
        }
        ...
        CustomMenuAxisTab(tagAxisTab: 2
                          ...
                          , titleAxisTab: "all"
                          , imageName:"mark") {
            StudentHomeworkView(finishedExam:"")
        }
