...
@available(iOS 16.0, *)
struct CategoriesLecturersGroupsView: View {
    ...
    @State private var showLecturersFromLecturerGroups : Bool = false
    ...
    var body: some View {
        NavigationView {
                    ...
                    VStack {
                        ...
                        .onAppear(perform: {
                            educationGroupsVm.getGroups(
                                ...
                                userServiceProviderToken: userProviderToken,educationalCategoryToken: categoryToken,
                                refresh:true)
                        })
                    }
                }
            ...
            .navigationBarItems(leading: CustomBackButton(){
                clearStatesWithAction(valueState: &showLecturersFromLecturerGroups)
            }
            )
        }
        ...
        .fullScreenCover(isPresented: $showLecturersFromLecturerGroups, content: {
            LecturersView()
        })
    ...
    private func clearStatesWithAction(valueState: inout Bool) {
        valueState.toggle()
        showLecturersFromLecturerGroups = false
    }
}
